...
Archivo		:	operadorinventario.php
Proposito	:	Menu Inventario para Operador.
...
<!-- aqui empieza -->
						...
						<table width="1000" align="center">
							<tr align="center">
								<td width="590" class="bordetabla"><h2>Inventario</h2></td>
								<td width="10"></td>
								<td width="400" class="bordetabla"><h2>Detalle Porducto</h2></td>
							</tr>
							<tr>
